...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.82\textwidth]{../assets/747.png}
\caption{Representative Boeing 747 airframe image corresponding to the aircraft class modeled in this report.}
